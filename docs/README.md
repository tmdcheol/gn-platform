...
```bash
mkdir -p docs/specs/<기능명>
cp docs/templates/spec.md  docs/specs/<기능명>/spec.md
cp docs/templates/plan.md  docs/specs/<기능명>/plan.md
cp docs/templates/tasks.md docs/specs/<기능명>/tasks.md
```
